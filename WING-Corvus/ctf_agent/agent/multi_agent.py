...
TOOL_WHITELIST: dict[str, set[str]] = {
    "web": {
        ...
        "file_type", "strings", "hex_dump",
        # web 专用工具
        "web_fingerprint", "web_dirscan", "web_recon", "web_sqli",
        "sqlmap", "lfi_scanner", "lfi_log_inject",
        "multi_encode", "auto_decode", "url_partial_encode", "php_filter_chain",
        # 通用分析
        "crypto_classic", "exploit_template",
        "share_finding", "check_findings",
    ...
    "pwn": {
        ...
        "hash_compute", "hash_identify",
        # pwn 专用工具
        "pwn_checksec", "pwn_cyclic", "pwn_ropgadget", "pwn_exploit",
        "binary_analyze", "angr_symbolic_exec", "mem_xor_analyze",
        # 通用分析
        "crypto_classic", "exploit_template",
        "share_finding", "check_findings",
        "list_shared_files", "read_shared_file", "write_shared_file",
    ...
    "crypto": {
        ...
        "file_type", "strings", "hex_dump",
        # crypto 专用工具
        "crypto_rsa", "crypto_classic",
        "ecdsa_nonce_reuse", "des_cryptanalysis",
        "common_d_attack", "feistel_decrypt",
        "lwe_decode",
        # crypto 扩展工具 (Sprint 36.5)
        "zkp_forge_proof", "otp_xor_analyze",
        "aes_sidechannel", "hash_collision", "mceliece_analyze",
        # 通用分析
        "exploit_template",
        "share_finding", "check_findings",
        "list_shared_files", "read_shared_file", "write_shared_file",
    ...
    "reverse": {
        ...
        "hash_compute", "hash_identify",
        # reverse 专用工具
        "binary_analyze", "mem_xor_analyze",
        "apk_jadx", "apktool",
        "angr_symbolic_exec", "ocr",
        # 通用分析
        "crypto_classic", "exploit_template",
        "share_finding", "check_findings",
        "list_shared_files", "read_shared_file", "write_shared_file",
